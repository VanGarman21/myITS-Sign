...
type SpesimenTandaTangan struct {
	IDSpesimen uuid.UUID  `json:"id_spesimen" gorm:"column:id_spesimen;primary_key;type:uniqueidentifier"`
	IDSDM      uuid.UUID  `json:"id_sdm" gorm:"column:id_sdm;type:uniqueidentifier"`
	Data       string     `json:"data" gorm:"column:data;type:varchar(max)"`
	CreatedAt  time.Time  `json:"created_at" gorm:"column:created_at"`
	UpdatedAt  time.Time  `json:"updated_at" gorm:"column:updated_at"`
	DeletedAt  *time.Time `json:"deleted_at" gorm:"column:deleted_at"`
	Updater    *uuid.UUID `json:"updater" gorm:"column:updater;type:uniqueidentifier"`
}
